...
* source ~/.zshrc (add `export PATH=$PATH:/opt/homebrew/bin` to ~/.zshrc, make sure that it is run before loading **plugins**. Also copy others in ~/.zshrc.pre-oh-my-zsh to the new ~/.zshrc)
#### configure tmux
* cd
